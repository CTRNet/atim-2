function initial() {
    ...
    $("#aliquot-sample").html("Keep the mouse pointer on top of a <b>Sample</b> item.")
...
debugger;
    ...
    $(document).tooltip({show: {effect: "fade", duration: 200, delay: 1000}});
